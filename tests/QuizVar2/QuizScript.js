const questions = [
    {
        question: "В чём вещественно воплощены основные средства:",
        answers: [
            { text: "в человеческих ресурсах;", correct: false },
            { text: "в уставном капитале предприятия;", correct: false },
            { text: "в средствах труда.", correct: true }
        ]
    },
    {
        question: "В состав оборотных фондов предприятия входят:",
        answers: [
            { text: "производственные запасы сырья, материалов, полуфабрикатов, покупных изделий, запасных частей, топлива, незавершенное производство, расходы будущих периодов;", correct: true },
            { text: "станки, агрегаты, приспособления, тара, стеллажи;", correct: false },
            { text: "прибыль предприятия, задолженность поставщикам.", correct: false }
        ]
    },
    {
        question: "... это объекты предприятия культурно-бытового назначения, медицинские учреждения, столовые.",
        answers: [
            { text: "основные производственные фонды;", correct: false },
            { text: "основные непроизводственные фонды;", correct: true },
            { text: "нематериальные активы.", correct: false }
        ]
    },
    {
    ...
    {
        question: "Эффективность использования оборотных средств характеризуют:",
        answers: [
            { text: "прибыль, рентабельность производства;", correct: false },
            { text: "коэффициент оборачиваемости, средняя продолжительность одного оборота оборотных средств;", correct: true },
            { text: "уровень отдачи оборотных средств.", correct: false }
        ]
    }
];
